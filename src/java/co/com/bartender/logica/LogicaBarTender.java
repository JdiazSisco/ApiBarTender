 ...
 */
package co.com.bartender.logica;

import co.com.bartender.datos.VasoDAO;
...
public class LogicaBarTender {
     ...
     */
    private ArrayList<Integer> recorrerArreglo(ArrayList<Integer> arreglo, int iteracion) {
     ...
     * @param arreglo
     */
    private void agregarResiduales(List<Integer> arreglo) {
        for (int i = 0; i < arreglo.size(); i++) {
            respuestaFinal.add(arreglo.get(i));
        }
    }
